function createUnityInstance(t, r, l) {
    ...
    var c = {
        ...
        GetMetricsInfo: function() {
            ...
            return {
                ...
                numJankedFrames: b.HEAPU32[u + 4 >> 2]
            }
        }
    };
    function h(e, t, r) {
                ...
                var t, r = {
                    ...
                    "zlib/inflate.js": function(e, t, r) {
                        ...
                        r.inflate = function(e, t) {
                            var r, n, o, i, a, s, l, d, f, u, c, h, m, b, g, p, w, v, y, k, _, x, S, E, U = 0, C = new L.Buf8(4), T = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                            ...
                            e: for (; ; )
                                ...
                                case 6:
                                    ...
                                    512 & r.flags && (r.check = R(r.check, n, h, i)),
                                    s -= h,
                                    i += h,
                                    r.length -= h),
                                    r.length))
                                ...
                                case 7:
                                    if (2048 & r.flags) {
                                        ...
                                        _ && h < s; )
                                            ;
                                        if (512 & r.flags && (r.check = R(r.check, n, h, i)),
                                        s -= h,
                                        i += h,
                                        _)
                                            break e
                                    ...
                                    if (r.last)
                                        ...
                                        case 1:
                                            ...
                                            if (D) {
                                                ...
                                                for (; A < 288; )
                                                    B.lens[A++] = 8;
                                                for (I(1, B.lens, 0, 288, Z, 0, B.work, {
                                                    bits: 9
                                                }),
                                                A = 0; A < 32; )
                                                    B.lens[A++] = 5;
                                                I(2, B.lens, 0, 32, M, 0, B.work, {
                                                    bits: 5
                                                }),
                                                D = !1
                                            }
                                ...
                                case 27:
                                    if (r.wrap) {
                                        ...
                                        e.total_out += c,
                                        r.total += c,
                                        c && (e.adler = r.check = (r.flags ? R : P)(r.check, o, c, a - c)),
                                        c = l,
                            ...
                            e.total_out += c,
                            r.total += c,
                            r.wrap && c && (e.adler = r.check = (r.flags ? R : P)(r.check, o, c, e.next_out - c)),
                        ...
                        r.inflateSetDictionary = function(e, t) {
                            var r, n = t.length;
                            return !e || !e.state || 0 !== (r = e.state).wrap && 11 !== r.mode ? F : 11 === r.mode && P(1, t, n, 0) !== r.check ? -3 : W(e, t, n, n) ? (r.mode = 31,
                            -4) : (r.havedict = 1,
                            z)
                        }
                        ,
                    ...
                    "zlib/inftrees.js": function(e, t, r) {
                        ...
                        t.exports = function(e, t, r, n, o, i, a, s) {
                            for (var l, d, f, u, c, h, m, b, g, p = s.bits, w = 0, v = 0, y = 0, k = 0, _ = 0, x = 0, S = 0, E = 0, U = 0, C = 0, T = null, A = 0, B = new O.Buf16(16), L = new O.Buf16(16), P = null, R = 0, w = 0; w <= 15; w++)
                                B[w] = 0;
                            for (v = 0; v < n; v++)
                                B[t[r + v]]++;
                            for (_ = p,
                            ...
                            0 === k)
                                ...
                                for (; ; ) {
                                    ...
                                    0),
                                    l = 1 << (m = w - S),
                                    y = d = 1 << x; o[c + (C >> S) + (d -= l)] = m << 24 | b << 16 | g | 0,
                                    0 !== d; )
                                        ;
                                    for (l = 1 << w - 1; C & l; )
                                        l >>= 1;
                                    ...
                                    if (_ < w && (C & u) !== f) {
                                        for (c += y,
                                        E = 1 << (x = w - (S = 0 === S ? _ : S)); x + S < k && !((E -= B[x + S]) <= 0); )
                                            x++,
                                            E <<= 1;
                                        if (U += 1 << x,
                                        1 === e && 852 < U || 2 === e && 592 < U)
    ...
    return new Promise(function(e, t) {
        ...
        t(r)) : b.SystemInfo.hasWasm ? (b.startupErrorHandler = t,
        l(0),
        ...
        y()) : t("Your browser does not support WebAssembly.") : t("Your browser does not support WebGL.")
    }
    )
}
